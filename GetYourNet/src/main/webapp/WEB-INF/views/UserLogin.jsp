    ...
    <div class="Absolute-Center is-Responsive">
      ...
      <div class="col-sm-12 col-md-10 col-md-offset-1">
        ...
        <form action="" id="loginForm">
          ...
          <div class="checkbox">
            <label>
              <input type="checkbox"> I agree to the <a href="TermsAndCondition">Terms and Conditions</a>
            </label>
          </div>
          
				 
				 <div class="form-group">
					<a href="LoggedUser" class="btn btn-primary btn-block" role="button">Login</a>
					</div>
